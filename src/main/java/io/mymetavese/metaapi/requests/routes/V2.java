...
public class V2 extends RouteAdapter {
    ...
    public V2() {
        ...
        this.routes.put("GET_TOKEN_METADATA", new Route(GET, "/tokens/{tokenId}/{index}"));
        ...
        this.routes.put("UPDATE_TOKEN_INDEX_PROPERTY", new Route(POST, "/tokens/{tokenId}/indexes/{tokenIndex}/properties/{propertyName}"));
